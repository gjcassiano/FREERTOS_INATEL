...
#define MAX_RETRYS           8 //4                   // nr. of resendings before reset conn.
                                                 // total nr. of transmissions = MAX_RETRYS + 1

#define MAX_TCP_TX_DATA_SIZE 1024   //512                 // max. outgoing TCP data size (even!)
#define MAX_TCP_RX_DATA_SIZE 512   //256                // max. incoming TCP data size (even!)
